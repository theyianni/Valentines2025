  ...
  return (
    ...
    >
      <div className="flex gap-4 p-6 bg-gradient-to-r from-gray-900 to-black relative z-50">
        <button
          className="px-6 py-3 rounded-full flex items-center gap-2 transition-all duration-300 transform hover:scale-105 bg-gradient-to-r from-green-500 to-cyan-500 text-white"
        >
          <Waves size={20} />
          Waves Flow
        </button>
